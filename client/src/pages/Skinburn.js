...
function SkinBurn({ prediction }) {

    const precision = (prediction.probability * 100).toFixed(2)

    const [data, setData] = useState([])
    const [image, setImage] = useState('./23.JPG')
    ...
    return (
        <div className="">
            ...
            <div className='grid place-items-center'>
                <h1 className='text-5xl font-white font-semibold text-white'>Skin Burn Classifier</h1>
